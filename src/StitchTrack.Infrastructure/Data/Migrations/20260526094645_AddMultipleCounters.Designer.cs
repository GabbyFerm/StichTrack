...
namespace StitchTrack.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260526094645_AddMultipleCounters")]
    partial class AddMultipleCounters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StitchTrack.Domain.Entities.CounterHistory", b =>
                {
                    ...
                    b.Property<Guid>("ProjectCounterId")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("ProjectCounterId", "ChangedAt");
            ...
            modelBuilder.Entity("StitchTrack.Domain.Entities.ProjectCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ProjectCounters", (string)null);
                });
            ...
            modelBuilder.Entity("StitchTrack.Domain.Entities.Session", b =>
                {
                    ...
                    b.Property<string>("PrimaryCounterName")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("StitchTrack.Domain.Entities.CounterHistory", b =>
                {
                    b.HasOne("StitchTrack.Domain.Entities.ProjectCounter", "ProjectCounter")
                        .WithMany("CounterHistoryEntries")
                        .HasForeignKey("ProjectCounterId")
            ...
            modelBuilder.Entity("StitchTrack.Domain.Entities.ProjectTag", b =>
                {
                    b.HasOne("StitchTrack.Domain.Entities.Project", null)
                        .WithMany("Tags")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
